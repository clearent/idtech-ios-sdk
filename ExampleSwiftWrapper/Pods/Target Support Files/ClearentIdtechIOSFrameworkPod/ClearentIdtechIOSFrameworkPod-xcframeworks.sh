...
variant_for_slice()
{
  ...
  "ClearentIdtechIOSFramework.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "ClearentIdtechIOSFramework.xcframework/ios-arm64")
    echo ""
    ;;
  "CocoaLumberjack.xcframework/ios-arm64_armv7")
    echo ""
    ;;
  "CocoaLumberjack.xcframework/watchos-arm64_i386_x86_64-simulator")
    echo "simulator"
    ;;
  "CocoaLumberjack.xcframework/watchos-arm64_32_armv7k")
    echo ""
    ;;
  "CocoaLumberjack.xcframework/tvos-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "CocoaLumberjack.xcframework/tvos-arm64")
    echo ""
    ;;
  "CocoaLumberjack.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "CocoaLumberjack.xcframework/ios-arm64_i386_x86_64-simulator")
    echo "simulator"
    ;;
  esac
}
